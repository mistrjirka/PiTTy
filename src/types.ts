...
export type PiEvent = AgentSessionEvent | RpcExtensionUIRequest | Record<string, unknown>;
export type { RpcCommand, RpcExtensionUIRequest, RpcExtensionUIResponse, RpcResponse, RpcSessionState, SessionStats };
...
export type SubagentStep = {
  ...
  tokens?: { total?: number | undefined; input?: number | undefined; output?: number | undefined } | undefined;
...
export type SubagentTranscriptEntry = {
  ...
  kind: "user" | "assistant" | "thinking" | "tool" | "toolResult" | "stderr" | "system";
  label?: string | undefined;
  text: string;
