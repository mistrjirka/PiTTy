...
- Inspector default selection, F6 cycling, Ctrl+I selection, the chooser, and replacement selection after a child disappears now all follow the same tree order as the sidebar.
- Added regressions for ambiguous ancestry and root-card ownership.
